...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="relative -z-10 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-primary fill-primary dark:bg-stone-900 dark:fill-stone-900" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
